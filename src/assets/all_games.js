...
let all_games = [
...

    {
        ...
        players: "3/6",
        age: "7",
        lo: "Acquire knowledge of the three paths: Brahma, Deva, and Pitru, and the yogis who traverse these paths to reach their respective destination lokas, commencing from the three nadis: Sushumna, Pingala, and Ida.\n2) Learn about the different lokas that these yogis pass through.\n3) Understand the process of laya, which leeds yogis to liberation.\n4) Explore the structure of the universe.\n5) Enhance memory skills.",         
